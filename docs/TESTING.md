...
Use `scripts/test_local_pipeline.sh` to verify the full path without requiring a real HDMI/AVR sink.
...
Use `scripts/test_pipewire_pipeline.sh` for strict validation of the native PipeWire output stream:
