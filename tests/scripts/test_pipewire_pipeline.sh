...
command -v pw-play >/dev/null 2>&1 || { error "pw-play not found"; exit 1; }
command -v pw-record >/dev/null 2>&1 || { error "pw-record not found"; exit 1; }
command -v pactl >/dev/null 2>&1 || { error "pactl not found (required for dummy driver)"; exit 1; }
